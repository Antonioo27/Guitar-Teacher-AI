...
2. **Pesi del modello** — `GuitarSet.pt` deve essere presente nel percorso `guitar_tutor_pipeline/weights/` oppure passarlo tramite CLI usando l'argomento `--weights`.
